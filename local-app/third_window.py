...
class ThirdWindow:
    ...
    # Real Value
    @staticmethod
    def add_real_value_box(window): return ThirdWindow.create_box(window, 1075, 435, "     Real_Val     ", "0.0000000000")
    # Predicted Value
    @staticmethod
    def add_predict_value_box(window): return ThirdWindow.create_box(window, 1370, 435, "     Pred_Val     ", "0.0000000000")
    # Difference
    @staticmethod
    def add_differ_box(window): return ThirdWindow.create_box(window, 1670, 435, "     Difference     ", "0.0000000000")
    # Adate & Time
    @staticmethod
    def add_adate_time_box(window): return ThirdWindow.create_box(window, 1355, 700, "    A_Date & Time    ", "----/--/-- ; 00:00")
    # Areal Value
    @staticmethod
    def add_areal_value_box(window): return ThirdWindow.create_box(window, 1070, 795, "    A_Real_Val    ", "0.0000000000")
    # Apredicted Value
    @staticmethod
    def add_apredict_value_box(window): return ThirdWindow.create_box(window, 1375, 795, "    A_Pred_Val    ", "0.0000000000")
    # Adifference
    @staticmethod
    def add_adiffer_box(window): return ThirdWindow.create_box(window, 1665, 795, "    A_Difference    ", "0.0000000000")
    # Mse Value
    @staticmethod
    def add_mse_value_box(window): return ThirdWindow.create_box(window, 650, 400, "    Mean_Squared_Error    ", "0.0000000000")
    # Mae Value
    @staticmethod
    def add_mae_value_box(window): return ThirdWindow.create_box(window, 650, 525, "    Mean_Absolute_Error    ", "0.0000000000")
    # Mape Value
    @staticmethod
    def add_mape_value_box(window): return ThirdWindow.create_box(window, 600, 650, " Mean_Absolute_Percentage_Error ", "0.0000000000")
