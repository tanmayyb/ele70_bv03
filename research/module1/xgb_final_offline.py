...
filepath = 'dataset.csv' # the user chooses the filepath and the app sets the filepath variable
target_name, dataset, dt = DatasetPreprocessor.load_dataset(filepath)
