...
\begin{column}{\colwidth}
  ...
  \begin{block}{Problem Statement}
    In this project, our goal is to \textbf{predict energy demand and detect anomalies in energy consumption habits} of zones and cities in Ontario using advanced time series forecasting and anomaly detection methods to allow utilities and organizations to make informed decisions in real-time.
...
\begin{column}{\colwidth}
  ...
  \begin{figure}
    \centering
    \includegraphics[height=8.5cm]{figures/gmm.png}
    \includegraphics[height=8.5cm]{figures/ad.png}
    \caption{Gaussian Mixture Model fit (left) and Anomaly Detection Model output (right)}
  \end{figure}
  Our \textbf{Anomaly Detection (AD)} method is based on statistical and probabilistic analysis of the error between the predicted and actual energy demand. We use \textbf{Gaussian Mixture Modelling (GMM)} with \textbf{Expectation-Maximization (EM)} algorithm for unsupervised latent state modelling to determine the likelihood that a given error value belongs to or falls outside of an expected distribution of error values.
  ...
  \begin{block}{Results}
    ...
    \begin{table}
      ...
      \begin{tabular}{l r r r c}
        ...
        \midrule
        XGBoost & 8.83\% & 7.63\% & =5\\% & =10 \\
        LSTM & \textbf{2.44\%} & \textbf{4.80\%} & =5\\% & =10 \\
        \bottomrule
      \end{tabular}
